...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "VLLM_BASE_URL",         "\"${project.findProperty("VLLM_BASE_URL")         ?: "http://localhost:8000"}\"")
        buildConfigField("String", "FISH_SPEECH_BASE_URL",  "\"${project.findProperty("FISH_SPEECH_BASE_URL")  ?: "http://localhost:8080"}\"")

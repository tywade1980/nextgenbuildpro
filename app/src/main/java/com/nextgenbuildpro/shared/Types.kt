...
/**
 * Knowledge Entry for storing unstructured construction industry data
 * Supports flexible metadata for categorization and search
 */
...
/**
 * Categories for construction industry knowledge
 */
...
/**
 * Workflow pattern detected from user actions
 */
data class WorkflowPattern(
    ...
    val frequency: Int = 0,
    val averageDuration: Long = 0L, // milliseconds
...
/**
 * Bottleneck analysis for workflow optimization
 */
data class BottleneckAnalysis(
    ...
    val location: String,
    val description: String,
    val impactScore: Double, // 0.0 to 1.0, higher is worse
    val frequencyCount: Int,
    val averageDelay: Long = 0L, // milliseconds
...
/**
 * Types of bottlenecks in workflows
 */
...
/**
 * Types of system metrics tracked
 */
...
/**
 * Automation suggestion generated by learning system
 */
data class AutomationSuggestion(
    ...
    val estimatedTimeSavings: Long = 0L, // milliseconds per execution
    val estimatedErrorReduction: Double = 0.0, // percentage
...
/**
 * Risk level for automation suggestions
 */
...
/**
 * Status of automation suggestion
 */
...
interface LearningAgent : SpecializedAgent {
     ...
     */
    suspend fun detectBottlenecks(patterns: List<WorkflowPattern>): Result<List<BottleneckAnalysis>>
